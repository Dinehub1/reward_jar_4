...
function LegacyTestBusinessManagementPage() {
  ...
  return (
    <ComponentErrorBoundary fallback={
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Business Test Unavailable</h2>
          <p className="text-gray-600 mb-4">Unable to load the business test</p>
          <button 
      ...
      <div className={modernStyles.layout.container}>
        <LegacyTestBusinessManagementPage />
      </div>
