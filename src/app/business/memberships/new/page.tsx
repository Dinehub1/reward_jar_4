...
export default function NewMembershipCard() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Insert membership card using Supabase for now
      ...
      router.push('/business/dashboard?success=membership_created')
    ...
    <BusinessLayout>
      <div className="max-w-4xl mx-auto p-4 md:p-6 lg:p-8 space-y-4 md:space-y-6 overflow-hidden">
        ...
        <div className="flex flex-col space-y-3 md:flex-row md:items-center md:space-y-0 md:space-x-4">
          <Link href="/business/dashboard" className="w-full md:w-auto">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-sm md:text-base text-gray-600">Set up a new membership program for your customers</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Configure your membership program settings. Customers will purchase sessions and track their usage.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-indigo-200">
            <CardHeader>
              ...
              <CardDescription>This is how your membership card will appear to customers</CardDescription>
            </CardHeader>
            <CardContent>
