...
export default function WalletPreviewPage() {
  ...
  const fetchAllCustomerCards = async () => {
    try {
      ...
      if (cards) {
        const formattedCards: CustomerCard[] = cards.map(card => ({
          id: card.id,
                ...
                <CardContent>
                  <div className="space-y-4">
                    {testResults.apple_debug && (
                      <div>
                        <h4 className="font-medium mb-2">Apple Wallet Debug:</h4>
                    ...
                    {testResults.google_debug && (
                      <div>
                        <h4 className="font-medium mb-2">Google Wallet Debug:</h4>
                        <pre className="text-xs bg-gray-100 p-3 rounded overflow-x-auto">
